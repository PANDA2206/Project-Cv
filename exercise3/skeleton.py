...
if __name__ == '__main__':
    ...
    print('Shape of mus (codebook):', mus.shape)
    # b) VLAD encoding
    ...
    if not os.path.exists(fname) or args.overwrite:
        ...
        print('Shape of enc_test:', enc_test.shape)
    ...
    print('Shape of new_enc_test (after E-SVM):', new_enc_test.shape)
